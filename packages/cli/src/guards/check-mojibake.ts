...
export function extractAffectedWordInfo(line: string, start: number, length: number): { word: string; wordStart: number; wordEnd: number } {
  let wordStart = start
...
export function buildLinePreview(line: string): string {
...
export function collectFindings(file: string, content: string, rootDir = process.cwd()): Finding[] {
...
export function applyWordReplacements(content: string, fixes: Finding[]): string {
...
export function buildFileFixPlan(
  filePath: string,
  content: string,
  findings: Finding[],
  rootDir = process.cwd(),
...
export function applyFixPlans(plans: FileFixPlan[], backupRoot: string): void {
...
export function verifyAndCleanupBackups(plans: FileFixPlan[], backupRoot: string): BackupCleanupResult {
...
export function runMojibakeGuard(
  argv: string[] = [],
  rootDir = process.cwd(),
): number {
